...
public class MainActivity extends Activity {
    ...
    final int PROGRESS_BAR_STATUS = (int) Math.ceil(100.0/mQuestionBank.length);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuestion = mQuestionBank[mIndex].getQuiestionID();
    ...
    private void update()
    {
        ...
        mQuestion = mQuestionBank[mIndex].getQuiestionID();
        mQuestionTextView.setText(mQuestion);
        mProgressBar.incrementProgressBy(PROGRESS_BAR_STATUS);
        mScoreTextView.setText("Score" + mScore + "/" + mQuestionBank.length);
    }
